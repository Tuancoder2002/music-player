    ...
    */
    ...
    var Music = {
        ...
        songs: [
                {
                    name: 'Khóa Ly Biệt',
                    singer_first: 'Voi Bản Đôn',
                    singer_second: '',  
                    singer_third: '', 
                    path: './assets/music/Khoa-Ly-Biet-Voi-Ban-Don.mp3',
                    image: './assets/img/voibandon.jpg',
                    time: '03.22'
                },
                {
                    name: 'Giờ Không Cưới Thì Nào Cưới',
                    singer_first: 'Hồng Quân WyTy, Young P',
                    singer_second: '',  
                    singer_third: '', 
                    path: './assets/music/song14.mp3',
                    image: './assets/img/khongcuoinaocuoi.jpg',
                    time: '03.22'
                },
                {
                    ...
                    image: './assets/img/quacauruocem.jpg',
                    time: '03.22'
                },
                {
                    name: 'Có Duyên Không Nợ Remix',
                    singer_first: 'NB3 Hoài Bảo',
                    singer_second: '',  
                    singer_third: '', 
                    path: './assets/music/song16.mp3',
                    image: './assets/img/coduyenkno.jpg',
                    time: '03.22'
                },
                {
                    name: 'Ngày Em Cưới',
                    singer_first: 'Nguyễn Vỹ',
                    singer_second: '',  
                    singer_third: '', 
                    path: './assets/music/song17.mp3',
                    image: './assets/img/ngayemcuoi.jpg',
                    time: '03.22'
                },
                {
                    name: 'Hoa Cỏ Lau Remix',
                    singer_first: 'Phong Max',
                    singer_second: '',  
                    singer_third: '', 
                ...
                {
                    name: 'Anh Là Quá Khứ Không Thể Quên',
                    singer_first: 'MyMy',
                    singer_second: '',  
                    singer_third: '', 
                    path: './assets/music/song19.mp3',
                    image: './assets/img/khongthequen.jpg',
                    time: '03.22'
                },
                {
                    name: 'Người Thay Thế Em Remix',
                    singer_first: 'Hoàng Lan, Jin Tuấn Nam',
                    singer_second: '',  
                    singer_third: '', 
                    path: './assets/music/song20.mp3',
                    image: './assets/img/ngthaythe.jpg',
                    time: '03.22'
                },
                {
                    name: 'Body Shaming Remix',
                    singer_first: 'Choco Trúc Phương',
                    singer_second: '',  
                    singer_third: '', 
                    path: './assets/music/song21.mp3',
                    image: './assets/img/body.jpg',
                    time: '03.22'
                },
                {
                    name: 'Cô Gái Này Là Của Ai (Speed Up)',
                    singer_first: 'Kirik x Rush',
                    singer_second: '',  
                    singer_third: '', 
                    path: './assets/music/song22.mp3',
                    image: './assets/img/cogainay.jpg',
                    time: '03.22'
                },
                {
                    name: 'Là Anh Remix',
                    singer_first: 'Phạm Lịch',
                    singer_second: '',  
                    singer_third: '', 
